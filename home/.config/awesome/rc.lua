...
local menu_browser = { "Firefox", "firefox" }
...
beautiful.menu_bg_focus="#434c5e"
...
mylauncher = awful.widget.launcher({ image = debian_icon,
                                     menu = mymainmenu })
...
textclock_clr:set_fg("#8fbcbb")


local mic_widget = mic({
	timeout = 10,
	settings = function(self)
		if self.state == "muted" then
			self.widget:set_image(gears.filesystem.get_configuration_dir() .. "assets/Mic_O1.png")
		else
			self.widget:set_image(gears.filesystem.get_configuration_dir() .. "assets/Mic_on1.png")
		end
	end
})

local widget_mic = wibox.widget { mic_widget, layout = wibox.layout.align.horizontal }
...
globalkeys = gears.table.join(
    ...
    awful.key({                 }, "XF86AudioNext",  function () awful.spawn("sp next", false)       end, {description = "next track",     group = "spotify"}),
    awful.key({                 }, "XF86AudioPrev",  function () awful.spawn("sp prev", false)       end, {description = "previous track", group = "spotify"}),
    awful.key({                 }, "XF86AudioStop",  function () awful.spawn("sp play", false)       end, {description = "play track",     group = "spotify"}),
    ...
    awful.key({ modkey,          }, "e", function () awful.spawn("thunar") end,
    	{description = "Open Thunar", group = "Thunar"})
)
...
awful.rules.rules = {
    ...
    -- Set Firefox to always map on the tag named "2" on screen 1.
     ...
     { rule = { class = "Spotify" },
       properties = { screen = 2, tag = "2", floating = true } },
}
-- }}}
...
awful.spawn.with_shell("picom --xrender-sync-fence") -- Start picom
awful.spawn.with_shell("numlockx") -- Set numlock
awful.util.spawn("openrgb -p Basic") -- Openrgb

-- Screen configuration
awful.spawn.with_shell("xrandr --output DP-0 --mode 2560x1440 --rate 165 --primary --output DP-4 --mode 1920x1080 --rate 144 --left-of DP-0")
